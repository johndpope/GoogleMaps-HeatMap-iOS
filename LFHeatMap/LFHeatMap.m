...
+ (UIImage *)heatMapForMapView:(GMSMapView *)mapView
                         boost:(float)boost
                     locations:(NSArray *)locations
                       weights:(NSArray *)weights
                         marla: (MKMapView *)mapViewt
{
    ...
    for (NSInteger i = 0; i < [locations count]; i++)
    {
        ...
        CGPoint point = [mapViewt convertCoordinate:location.coordinate toPointToView:mapViewt];
        //CGPoint point = [mapView.projection pointForCoordinate: location.coordinate];
    ...
    CGRect frame = CGRectMake(0, 0, 16.699*22.45, 11.443*58.29);
                     ...
                     weights:(NSArray *)weights
{
    ...
    NSValue *pointValue = [points objectAtIndex: 0];
    CGFloat p = [pointValue CGPointValue].x;
    NSLog(@"%f", p);
